...
int main()
{
	...
	//~ cout << mat2 << endl;
//~ 
	//~ mat2->cambiarFilas(1,2);
	//~ cout << "--------------" << endl;
	//~ cout << mat2 << endl;
	
	//~ Matriz* mat30 = mat->Identidad(3);
	//~ mat30->cambiarFilas(0,1);
	//~ cout << mat30 << endl;
	
	//~ //Test LU
	//~ cout << mat2 << endl;
	Matriz* mat30 = new Matriz(3,3,1,1);
	mat30->leer_Matriz("MatrizFruta.txt");
	cout << "--------------" << endl;
	...
	Matriz* matP = get<0>(fact);
	matP = (*matP)*get<1>(fact);
	matP = (*matP)*get<2>(fact);
	cout << "El producto da:" << endl;
	cout << matP << endl;
	cout << "--------------" << endl;
	cout << "La matriz era:"<< endl;
	cout << mat2 << endl;
